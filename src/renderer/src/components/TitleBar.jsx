...
const C = {
  bg: "#0b0d14", border: "#1f2335",
  pink: "#f472b6", pinkDim: "#9d346b",
  cyan: "#22d3ee", green: "#4ade80",
  textMuted: "#475569", textSecondary: "#94a3b8", textPrimary: "#e2e8f0",
  bg3: "#1f2335",
};

export default function TitleBar({ onWeeklyReview, onSettings, debugMode, onToggleDebug }) {
  return (
    <div
    ...
    >
      ...
      <div className="titlebar-no-drag" style={{ display: "flex", alignItems: "center", gap: 10 }}>
        <span style={{
          ...
          color: C.pink, fontFamily: "'JetBrains Mono', monospace",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
          ...
          <span style={{ fontSize: 11, color: C.textSecondary }}>Session active</span>
        </div>
      </div>
      ...
      <div className="titlebar-no-drag" style={{ display: "flex", gap: 5, alignItems: "center" }}>
        <TitleBtn
          label="DEBUG"
          active={debugMode}
          activeColor={C.cyan}
  ...
  return (
    <button
      ...
      style={{
        ...
        background: active ? `${activeColor}18` : (accent ? "#f472b615" : "transparent"),
      ...
      onMouseLeave={(e) => {
        e.currentTarget.style.color = active ? activeColor : (accent ? "#f472b6" : "#475569");
        e.currentTarget.style.borderColor = active ? activeColor : (accent ? "#9d346b" : "#252a3d");
      }}
    >
      {label}
    </button>
