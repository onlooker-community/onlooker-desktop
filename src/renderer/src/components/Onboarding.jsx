...
function Step({ n, label, done }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
      ...
      <span style={{ fontSize: 13, color: done ? C.textMuted : C.textPrimary,
...
function LinkBtn({ label, href, accent }) {
  return (
    <a href={href} target="_blank" rel="noopener noreferrer" style={{
      ...
      onMouseEnter={(e) => e.currentTarget.style.background = accent ? `${C.pink}25` : C.bg2}
      onMouseLeave={(e) => e.currentTarget.style.background = accent ? `${C.pink}15` : "transparent"}
    >
      {label} →
    </a>
  );
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 28 }}>
          <div style={{
            ...
            background: `${C.pink}18`, border: `1px solid ${C.pink}44`,
            display: "flex", alignItems: "center", justifyContent: "center",
            fontSize: 18, color: C.pink,
          }}>✦</div>
          <div>
            <div style={{ fontSize: 14, fontWeight: 700, color: C.textPrimary,
              letterSpacing: "0.05em" }}>Onlooker</div>
            <div style={{ fontSize: 11, color: C.textMuted }}>Claude Code observability</div>
          </div>
        </div>
        ...
        {state === "fresh" && (
          <>
            ...
            <div style={{ fontSize: 13, color: C.textSecondary, lineHeight: 1.6, marginBottom: 24 }}>
              ...
              quality scores, and weekly reviews. It reads the logs your plugins write
            ...
            <div style={{ display: "flex", gap: 8 }}>
              <LinkBtn label="View setup guide" href="https://onlooker.dev/docs/setup" accent />
        ...
        {state === "no_plugins" && (
          <>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              <LinkBtn label="Plugin setup guide" href="https://onlooker.dev/docs/plugins" accent />
        ...
        {state === "no_logs" && (
          <>
            ...
            <div style={{ fontSize: 13, color: C.textSecondary, lineHeight: 1.6, marginBottom: 24 }}>
              Onlooker plugins are installed. Start a Claude Code session and events
              will appear in the Live Feed automatically.
            </div>
